...
void main (void) 
{
	...
	/* 
		We need to do these:
		1. Clear Screen using "printf("\x1b[2J");"
		2. Configure pins as analog input
		3. Read and display tested voltage .. in a loop!
	
	*/
	

	InitPinADC(2, 2); // initialize P2.2
	InitADC();

	while(1)
	{
		v = Volts_at_Pin(QFP32_MUX_P2_2);
		t = 100*(v-2.73);
        average = ;

		// printf ("Voltage at P2.2=%.5fV\r", v);
		printf ("%7.5f\n", average);
		WaitXms(500);
